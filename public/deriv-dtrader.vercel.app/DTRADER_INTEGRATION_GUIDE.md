...
function DTraderIframe() {
    ...
    useEffect(() => {
        try {
            ...
            const appId = process.env.REACT_APP_DERIV_APP_ID || '128453';
...
- [ ] **Token Injection Works**
  ```bash
  # Test URL manually
  https://deriv-dtrader.vercel.app/dtrader?acct1=CR123456&token1=test_token&cur1=USD&lang=EN&app_id=128453
  ```
